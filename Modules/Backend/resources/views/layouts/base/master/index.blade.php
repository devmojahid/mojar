...
<body>
  ...
  <div class="page">
    <!-- Sidebar -->
    @include("base.navigation.index")
    <!-- Navbar -->
    @include("base.header.index")
          ...
          <div class="row row-deck row-cards">
                    ...
                    <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                      <div class="divide-y">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/002m.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/003m.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/000f.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/001f.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/002f.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/003f.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/006m.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/004f.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/007m.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/009m.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/010m.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/005f.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                        ...
                        <div>
                          <div class="row">
                            <div class="col-auto">
                              <span class="avatar" style="background-image: url({{ asset('base/assets') }}/static/avatars/006f.jpg)"></span>
                            </div>
                            <div class="col">
                              <div class="text-truncate">
                  ...
                  <table class="table table-vcenter">
                    ...
                    <tbody>
                      <tr>
                        <td class="w-1">
                          <span class="avatar avatar-sm"
                            style="background-image: url({{ asset('base/assets') }}/static/avatars/000m.jpg)"></span>
                        </td>
                      ...
                      <tr>
                        <td class="w-1">
                          <span class="avatar avatar-sm"
                            style="background-image: url({{ asset('base/assets') }}/static/avatars/002m.jpg)"></span>
                        </td>
                        <td class="td-truncate">
                          <div class="text-truncate">
                      ...
                      <tr>
                        <td class="w-1">
                          <span class="avatar avatar-sm"
                            style="background-image: url({{ asset('base/assets') }}/static/avatars/003m.jpg)"></span>
                        </td>
                        <td class="td-truncate">
                          <div class="text-truncate">
                      ...
                      <tr>
                        <td class="w-1">
                          <span class="avatar avatar-sm"
                            style="background-image: url({{ asset('base/assets') }}/static/avatars/000f.jpg)"></span>
                        </td>
                        <td class="td-truncate">
                          <div class="text-truncate">
            ...
            <div class="col-md-6 col-lg-4">
              <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank" rel="noopener"
                style="background-image: url({{ asset('base/assets') }}/static/sponsor-banner-homepage.svg)" aria-label="Sponsor Tabler!">
                ...
                <div class="table-responsive">
                  <table class="table card-table table-vcenter">
                    <tr>
                      ...
                      <td>
                        <span class="avatar avatar-sm" style="background-image: url({{ asset('base/assets') }}/static/avatars/000m.jpg)"></span>
                      </td>
                    </tr>
                    <tr>
                      <td class="w-1 pe-0">
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="avatar avatar-sm" style="background-image: url({{ asset('base/assets') }}/static/avatars/002m.jpg)"></span>
                      </td>
                    </tr>
                    <tr>
                      <td class="w-1 pe-0">
                      ...
                      <td>
                        <span class="avatar avatar-sm" style="background-image: url({{ asset('base/assets') }}/static/avatars/003m.jpg)"></span>
                      </td>
                    </tr>
                    <tr>
                      <td class="w-1 pe-0">
                      ...
                      <td>
                        <span class="avatar avatar-sm" style="background-image: url({{ asset('base/assets') }}/static/avatars/000f.jpg)"></span>
                      </td>
                    </tr>
                    <tr>
                      <td class="w-1 pe-0">
                      ...
                      <td>
                        <span class="avatar avatar-sm" style="background-image: url({{ asset('base/assets') }}/static/avatars/001f.jpg)"></span>
                      </td>
                    </tr>
                  </table>
                </div>
  ...
  <!-- Libs JS -->
  <script src="{{ asset('base/assets') }}/libs/apexcharts/dist/apexcharts.min.js?1684106062" defer></script>
  <script src="{{ asset('base/assets') }}/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062" defer></script>
  <script src="{{ asset('base/assets') }}/libs/jsvectormap/dist/maps/world.js?1684106062" defer></script>
  <script src="{{ asset('base/assets') }}/libs/jsvectormap/dist/maps/world-merc.js?1684106062" defer></script>
  <!-- Tabler Core -->
